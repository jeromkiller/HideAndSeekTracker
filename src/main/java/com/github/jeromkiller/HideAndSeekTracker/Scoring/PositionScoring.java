...
@AllArgsConstructor
@NoArgsConstructor
public class PositionScoring implements PointSystem {
    final ScoreType scoreType = ScoreType.POSITION;
    ...
    @Override
    public int getFallThroughScore() {
        return fallThroughScore;
    }

    @Override
    public void setFallThroughScore(int score) {
        fallThroughScore = score;
    }
